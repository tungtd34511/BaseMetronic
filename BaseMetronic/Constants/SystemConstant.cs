...
namespace BaseMetronic.Constants
{
    public class SystemConstant
    {
        ...
        public struct FileStorage
        {
            ...
            public const string FOLDER_THUMB_NAME = "thumb";
            public const string DEFAULT_THUMB = "/admin/assets/media/question/NoImage.png";
            /// <summary>
            /// Độ rộng tối đa của ảnh bìa
            /// </summary>
            public const float MAXIMUN_THUMB_WIDTH = 210;
            public const float MAXIMUM_IMAGE_WIDTH = 1920;//full HD
            public static string[] ImgExtensions = new string[] {
        ".jpeg", ".jpg", ".png", ".gif",
        ".bmp", ".webp", ".tiff"
  };
        ...
        {".vtt", "text/vtt"},
            ...
            public static string GetMimeType(string extension)
            {
                ...
                return _mappings.TryGetValue(extension, out mime) ? mime ?? "application/octet-stream" : "application/octet-stream";
            }
        }
    }
}
